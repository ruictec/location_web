            ...
            >
              ...
              >
                <template #default="scope">
                  <el-popconfirm
                    :title="'确定要删除' + scope.row.tenId + '？'"
                    width="auto"
                    @confirm="delTer(scope)"
                  >
                    <template #reference><el-button type="danger" class="dels"
...
import { getNsTenantInfoList, delTenantOperateNs } from "@/axios/api";
