...
<template #dropdown><el-dropdown-menu
          ...
          <!-- 添加 -->
          <el-dialog
            :title="$t('otherDev.addinfoCamera')"
            width="30%"
            v-model="add"
          ...
          >
            ...
            >
              ...
              <el-form-item label="IP：" style="margin-right: 2%" prop="mode">
                <el-input v-model="addData.mode"> </el-input>
              </el-form-item>
              <el-form-item
                :label="$t('beacon.company')"
                style="margin-right: 2%"
          ...
          <!-- 编辑 -->
          <el-dialog
            :title="$t('otherDev.editinfoCamera')"
            width="30%"
            class="edit"
            v-model="edit"
            style="text-align: center"
          ...
          <!-- 分配aoa -->
          <el-dialog
            :title="$t('otherDev.assigninfoCamera')"
            v-model="assign"
            class="edit"
            width="30%"
            style="text-align: center"
          ...
          <!-- 批量分配AOA -->
          <el-dialog
            :title="$t('otherDev.assigninfosCamera')"
            v-model="assigns"
            class="edit"
            width="30%"
            style="text-align: center"
  ...
  methods: {
    ...
    recycleAoa(index) {
      ...
      if (this.tableData[index].inallot == 2) {
        this.$message({
          message: that.$t("otherDev.CameraMes1"),
          type: "warning",
        });
        return;
      }
    ...
    removeAoas() {
      ...
      if (that.multipleSelection.length == 0) {
        that.$message({
          message: that.$t("otherDev.CameraMes2"),
          type: "warning",
        });
        return;
      }
      for (let i = 0; i < this.multipleSelection.length; i++) {
        if (this.multipleSelection[i].inallot == 2) {
          this.$message({
            message: this.$t("otherDev.CameraMes1"),
            type: "warning",
          });
          return;
        }
    ...
    assignAoa(index) {
      if (this.tableData[index].inallot == 1) {
        this.$message({
          message: this.$t("otherDev.CameraMes3"),
          type: "warning",
        });
        return;
      }
    ...
    assignAoas() {
      ...
      if (this.multipleSelection.length == 0) {
        this.$message({
          message: this.$t("otherDev.CameraMes4"),
          type: "warning",
        });
        return;
      }
